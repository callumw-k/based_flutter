...
`pubspec.lock` **is** synced: generated projects should start on the dependency set the reference was tested against, not on whatever resolves latest at generation time.
